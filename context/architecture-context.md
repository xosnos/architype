...
- Public routes: `/login`, `/signup`, `/auth/callback`, `/auth/revert-email`, `/api/account/email/revert`. Session-protected routes include `/dashboard`, `/settings`, and `/projects/[projectId]`.
